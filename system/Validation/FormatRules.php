...
class FormatRules
{
    ...
    public function alpha_space($value = null): bool
    {
        ...
        // @see http://regex101.com/r/LhqHPO/1
     ...
     *
     * @see http://regex101.com/r/XfVY3d/1
     *
     * @param string|null $str
     */
     ...
     * @return bool
     *
     * @see http://regex101.com/r/6N8dDY/1
     */
    ...
    public function alpha_numeric_space($str = null): bool
    {
        ...
        // @see http://regex101.com/r/0AZDME/1
    ...
    public function decimal($str = null): bool
    {
        ...
        // @see http://regex101.com/r/HULifl/2/
    ...
    public function numeric($str = null): bool
    {
        ...
        // @see http://regex101.com/r/bb9wtr/2
    ...
    public function valid_email($str = null): bool
    {
        ...
        // @see http://regex101.com/r/wlJG1t/1/
