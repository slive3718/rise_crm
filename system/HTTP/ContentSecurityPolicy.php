 ...
 * @see http://www.owasp.org/index.php/Content_Security_Policy
...
class ContentSecurityPolicy
{
     ...
     * For example: child-src http://youtube.com would enable embedding
     ...
     *
     * @see http://www.w3.org/TR/CSP/#directive-manifest-src
     *
     * @param array|string $uri
     *
     * @return $this
