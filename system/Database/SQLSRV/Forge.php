...
class Forge extends BaseForge
{
     ...
     *
     * @see http://docs.microsoft.com/en-us/sql/relational-databases/system-stored-procedures/sp-rename-transact-sql?view=sql-server-2017
     * 'EXEC sp_rename %s , %s ;'
     *
     * @var string
     */
    ...
    protected function _attributeType(array &$attributes)
    {
        ...
        switch (strtoupper($attributes['TYPE'])) {
            ...
            case 'ENUM':
                ...
                // bytes (0 to 8,000).
                // http://learn.microsoft.com/en-us/sql/t-sql/data-types/char-and-varchar-transact-sql?view=sql-server-ver16#remarks
                $maxLength = max(
                    array_map(
