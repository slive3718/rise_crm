...
if (! function_exists('command')) {
    ...
    function command(string $command)
    {
         ...
         *
         * @see http://github.com/symfony/symfony/blob/master/src/Symfony/Component/Console/Input/StringInput.php
         */
        while ($cursor < $length) {
...
if (! function_exists('is_cli')) {
    ...
    function is_cli(): bool
    {
        ...
        // See http://github.com/codeigniter4/CodeIgniter4/pull/5393
...
if (! function_exists('is_really_writable')) {
     ...
     *
     * @see http://bugs.php.net/bug.php?id=54709
     *
     * @throws Exception
     *
 ...
 *
 * @see http://github.com/laravel/framework/blob/8.x/src/Illuminate/Support/helpers.php
 */
