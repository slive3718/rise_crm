...
class CLI
{
    ...
    public static function init()
    {
        if (is_cli()) {
            ...
            // For "! defined('STDOUT')" see: http://github.com/codeigniter4/CodeIgniter4/issues/7047
     ...
     *
     * Reference: http://github.com/composer/xdebug-handler/blob/master/src/Process.php
     *
     * @param resource $resource
     */
    public static function hasColorSupport($resource): bool
    {
        // Follow http://no-color.org/
