...
class Paytm {
    ...
    public function __construct() {
        ...
        if ($paytm_config->paytm_testing_environment == "1") {
            $this->paytm_url = "http://securegw-stage.paytm.in/theia/processTransaction";
        } else {
            $this->paytm_url = "http://securegw.paytm.in/theia/processTransaction";
        }

        /*
          File from http://github.com/Paytm-Payments/Paytm_Web_Sample_Kit_PHP
