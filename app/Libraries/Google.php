...
class Google {
    ...
    public function upload_file($temp_file, $file_name, $folder_name = "", $file_content = "", $file_size = 0) {
        ...
        if ($file_content) {
            ...
            //Note: 
            //The suggested url by google drive documentaion is http://www.googleapis.com/upload/drive/v3/files?uploadType=media. 
            //http://developers.google.com/drive/api/guides/manage-uploads
            //But there might be any bug in the MediaFileUpload. So, use the following url: 
            //http://www.googleapis.com/drive/v3/files?uploadType=resumable
