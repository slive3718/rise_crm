...
<table class="table-responsive" style="width: 100%;">
    ...
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        ...
        <th style="text-align: center;  width: 20%; border-right: 1px solid #eee;"> <?php echo app_lang("rate"); ?></th>
        <th style="text-align: center;  width: 20%; "> <?php echo app_lang("total"); ?></th>
    </tr>
    <?php
    ...
    ?>
          <tr style="background-color: <?php echo $item_background; ?>;">
            <td style="width: 45%; border: 1px solid #fff; padding: 10px; hyphens: auto;"><?php echo $item->title; ?>
                <br />
                <span style="color: #888; font-size: 90%;"><?php echo custom_nl2br($item->description ? process_images_from_content(strip_tags($item->description)) : ""); ?></span>
            </td>
...
<!-- <img src="<?=(base_url().'assets/images/footer_bg.png');?>" style="width: 1900px; height:auto; position:absolute"> -->
    <?php 
