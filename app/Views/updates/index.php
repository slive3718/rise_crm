            ...
            <div class="card">
                <div class="page-title clearfix">
                    ...
                    <div class="title-button-group">
                        <?php echo "<a href='#' class='btn btn-info text-white font-18' data-toggle='app-modal' data-sidebar='0' data-type='iframe'  data-content_url='" . get_setting("app_update_url") . "info'" . "' data-title='Info'><i data-feather='info' class='icon-16'></i></a>"; ?>
                    </div>
                </div>
