        ...
        <div class="col-sm-9 col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="client_can_access_notes" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('client_can_access_notes'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_checkbox("client_can_access_notes", "1", get_setting("client_can_access_notes") ? true : false, "id='client_can_access_notes' class='form-check-input ml15'");
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="default_permissions_for_non_primary_contact" class="col-md-2 col-xs-8 col-sm-4"><?php echo app_lang('default_permissions_for_non_primary_contact'); ?></label>
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                <?php
                                echo form_input(array(
