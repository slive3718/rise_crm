...
<script type="text/javascript">
    ...
    source: '<?php echo_uri("clients/list_data") ?>',
            serverSide: true,
            //a to z and _ only. should be unique to avoid conflicts
...
<?php echo $custom_field_filters; ?>
            ...
            {title: "<?php echo app_lang("projects") ?>", "class":"text-center"},
            {visible: showInvoiceInfo, searchable: showInvoiceInfo, title: "<?php echo app_lang("total_invoiced") ?>", "class":"text-center"},
            {visible: showInvoiceInfo, searchable: showInvoiceInfo, title: "<?php echo app_lang("payment_received") ?>", "class":"text-center"},
