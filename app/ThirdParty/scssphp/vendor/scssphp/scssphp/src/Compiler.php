...
class Compiler
{
    ...
    {
        // http://sass-lang.com/documentation/at-rules/import
...
EOL;
     ...
     * byte-order mark.
     *
     * [byte-order mark]: http://en.wikipedia.org/wiki/Byte_order_mark#UTF-8
     *
     * @param bool $charset
     *
     * @return void
    ...
    /**
     * Convert HWB to RGB
     * http://www.w3.org/TR/css-color-4/#hwb-to-rgb
     *
     * @api
     *
     * @param int|float $hue        H from 0 to 360
