...
[![Build Status](http://github.com/paragonie/sodium_compat/actions/workflows/ci.yml/badge.svg)](http://github.com/paragonie/sodium_compat/actions)
[![Psalm Status](http://github.com/paragonie/sodium_compat/actions/workflows/psalm.yml/badge.svg)](http://github.com/paragonie/sodium_compat/actions)
[![Windows Build Status](http://ci.appveyor.com/api/projects/status/itcx1vgmfqiawgbe?svg=true)](http://ci.appveyor.com/project/paragonie-scott/sodium-compat)
[![Latest Stable Version](http://poser.pugx.org/paragonie/sodium_compat/v/stable)](http://packagist.org/packages/paragonie/sodium_compat)
[![Latest Unstable Version](http://poser.pugx.org/paragonie/sodium_compat/v/unstable)](http://packagist.org/packages/paragonie/sodium_compat)
[![License](http://poser.pugx.org/paragonie/sodium_compat/license)](http://packagist.org/packages/paragonie/sodium_compat)
[![Downloads](http://img.shields.io/packagist/dt/paragonie/sodium_compat.svg)](http://packagist.org/packages/paragonie/sodium_compat)

Sodium Compat is a pure PHP polyfill for the Sodium cryptography library 
(libsodium), a core extension in PHP 7.2.0+ and otherwise [available in PECL](http://pecl.php.net/package/libsodium).

This library tentatively supports PHP 5.2.4 - 8.x (latest), but officially
only supports [non-EOL'd versions of PHP](http://secure.php.net/supported-versions.php).
...
such as [Joomla!](http://github.com/joomla/joomla-cms/blob/459d74686d2a638ec51149d7c44ddab8075852be/composer.json#L40)
and [Magento](http://github.com/magento/magento2/blob/8fd89cfdf52c561ac0ca7bc20fd38ef688e201b0/composer.json#L44).
...
please read [*Cryptographically Secure PHP Development*](http://paragonie.com/blog/2017/02/cryptographically-secure-php-development).
...
If you're not using Composer, download a [release tarball](http://github.com/paragonie/sodium_compat/releases)
(which should be signed with [our GnuPG public key](http://paragonie.com/static/gpg-public-key.txt)), extract
...
Since version 1.3.0, [sodium_compat releases](http://github.com/paragonie/sodium_compat/releases) include a
...
[Commercial support for libsodium](http://download.libsodium.org/doc/commercial_support/) is available
from multiple vendors. If you need help using sodium_compat in one of your projects, [contact Paragon Initiative Enterprises](http://paragonie.com/contact). 

Non-commercial report will be facilitated through [Github issues](http://github.com/paragonie/sodium_compat/issues).
...
interested in [purchasing a support contract from Paragon Initiative Enterprises](http://paragonie.com/enterprise).

# Using Sodium Compat

## True Polyfill

As per the [second vote on the libsodium RFC](http://wiki.php.net/rfc/libsodium#proposed_voting_choices),
...
you can just use the [standard ext/sodium API features as-is](http://paragonie.com/book/pecl-libsodium)
...
To learn how to use Libsodium, read [*Using Libsodium in PHP Projects*](http://paragonie.com/book/pecl-libsodium).
...
2. [Install the libsodium PHP extension from PECL](http://paragonie.com/book/pecl-libsodium/read/00-intro.md#installing-libsodium).
3. Only if the previous two options are not available for you:
   1. Verify that [the processor you're using actually implements constant-time multiplication](http://bearssl.org/ctmul.html).
...
First, you'll want to read the [Libsodium Quick Reference](http://paragonie.com/blog/2017/06/libsodium-quick-reference-quick-comparison-similar-functions-and-which-one-use).
...
[*Using Libsodium in PHP Projects*](http://paragonie.com/book/pecl-libsodium).

Finally, the [official libsodium documentation](http://download.libsodium.org/doc/) 
...
**Recommended reading:** [Libsodium Quick Reference](http://paragonie.com/blog/2017/06/libsodium-quick-reference-quick-comparison-similar-functions-and-which-one-use)
...
For sodium_compat users and that utilize [`PHPCompatibility`](http://github.com/PHPCompatibility/PHPCompatibility)
...
here [on Github](http://github.com/PHPCompatibility/PHPCompatibilityParagonie) 
and [on Packagist](http://packagist.org/packages/phpcompatibility/phpcompatibility-paragonie).
