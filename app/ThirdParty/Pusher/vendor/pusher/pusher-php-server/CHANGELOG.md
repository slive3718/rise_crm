...
* [REMOVED] Support for legacy push notifications (this has been superseded by http://github.com/pusher/push-notifications-php)
...
* [ADDED] This release adds support for end to end encrypted channels, a new feature for Channels. Read more [in our docs](http://pusher.com/docs/client_api_guide/client_encrypted_channels).
...
* [NEW] Added namespaces (thanks [@vinkla](http://github.com/vinkla)).
...
* [FIXED] Overwritten socket_id parameter in trigger: http://github.com/pusher/pusher-php-server/pull/3
