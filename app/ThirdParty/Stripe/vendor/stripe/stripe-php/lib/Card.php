 ...
 *
 * Related guide: <a href="http://stripe.com/docs/sources/cards">Card Payments
 * with Sources</a>.
 *
 ...
 * @property null|string $currency Three-letter <a href="http://stripe.com/docs/payouts">ISO code for currency</a>. Only applicable on accounts (not customers or recipients). The card can be used as a transfer destination for funds in this currency.
...
class Card extends ApiResource
{
     ...
     *
     * @see http://stripe.com/docs/api/cards/object#card_object-cvc_check
     */
     ...
     *
     * @see http://stripe.com/docs/api/cards/object#card_object-funding
     */
     ...
     *
     * @see http://stripe.com/docs/api/cards/object#card_object-tokenization_method
     */
