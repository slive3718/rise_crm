 ...
 * href="http://stripe.com/docs/api/checkout/sessions">checkout session</a> to
 * render the payment page. You can use <a
 * href="http://stripe.com/docs/api/events/types#event_types-checkout.session.completed">checkout
 * session events</a> to track payments through payment links.
 *
 * Related guide: <a href="http://stripe.com/docs/payment-links">Payment Links
 * API</a>
 *
 ...
 * @property null|string|\Stripe\Account $on_behalf_of The account on behalf of which to charge. See the <a href="http://support.stripe.com/questions/sending-invoices-on-behalf-of-connected-accounts">Connect documentation</a> for details.
 ...
 * @property null|string[] $payment_method_types The list of payment method types that customers can use. When <code>null</code>, Stripe will dynamically show relevant payment methods you've enabled in your <a href="http://dashboard.stripe.com/settings/payment_methods">payment method settings</a>.
