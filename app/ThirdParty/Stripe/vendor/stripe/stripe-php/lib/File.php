 ...
 * href="http://stripe.com/docs/api#create_file">create file</a> request (for
 ...
 * query</a>).
 *
 * Related guide: <a href="http://stripe.com/docs/file-upload">File Upload
 * Guide</a>.
 *
 ...
 * @property null|\Stripe\Collection<\Stripe\FileLink> $links A list of <a href="http://stripe.com/docs/api#file_links">file links</a> that point at this file.
 * @property string $purpose The <a href="http://stripe.com/docs/file-upload#uploading-a-file">purpose</a> of the uploaded file.
