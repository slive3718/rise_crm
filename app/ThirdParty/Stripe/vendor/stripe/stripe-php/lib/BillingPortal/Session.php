 ...
 *
 * Learn more in the <a
 * href="http://stripe.com/docs/billing/subscriptions/integrating-customer-portal">integration
 * guide</a>.
 *
 ...
 * @property null|\Stripe\StripeObject $flow Information about a specific flow for the customer to go through. See the <a href="http://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
 ...
 * @property null|string $on_behalf_of The account for which the session was created on behalf of. When specified, only subscriptions and invoices with this <code>on_behalf_of</code> account appear in the portal. For more information, see the <a href="http://stripe.com/docs/connect/charges-transfers#on-behalf-of">docs</a>. Use the <a href="http://stripe.com/docs/api/accounts/object#account_object-settings-branding">Accounts API</a> to modify the <code>on_behalf_of</code> account's branding settings, which the portal displays.
