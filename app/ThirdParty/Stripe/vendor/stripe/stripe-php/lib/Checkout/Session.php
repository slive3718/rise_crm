 ...
 * href="http://stripe.com/docs/payments/checkout">Checkout</a> or <a
 * href="http://stripe.com/docs/payments/payment-links">Payment Links</a>. We
 ...
 * <a href="http://stripe.com/docs/api/customers">Customer</a>, and either the
 * successful <a
 * href="http://stripe.com/docs/api/payment_intents">PaymentIntent</a> or an
 * active <a href="http://stripe.com/docs/api/subscriptions">Subscription</a>.
 *
 * You can create a Checkout Session on your server and redirect to its URL to
 * begin Checkout.
 *
 * Related guide: <a href="http://stripe.com/docs/checkout/quickstart">Checkout
 * Quickstart</a>.
 *
