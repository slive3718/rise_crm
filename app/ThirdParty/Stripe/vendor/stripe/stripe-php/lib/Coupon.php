 ...
 * href="http://stripe.com/docs/api#subscriptions">subscriptions</a>, <a
 * href="http://stripe.com/docs/api#invoices">invoices</a>, <a
 * href="http://stripe.com/docs/api/checkout/sessions">checkout sessions</a>, <a
 * href="http://stripe.com/docs/api#quotes">quotes</a>, and more. Coupons do not
 * work with conventional one-off <a
 * href="http://stripe.com/docs/api#create_charge">charges</a> or <a
 * href="http://stripe.com/docs/api/payment_intents">payment intents</a>.
 *
 ...
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="http://stripe.com/docs/currencies">ISO code for the currency</a> of the amount to take off.
 * @property null|\Stripe\StripeObject $currency_options Coupons defined in each available currency option. Each key must be a three-letter <a href="http://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="http://stripe.com/docs/currencies">supported currency</a>.
