 ...
 * href="http://stripe.com/docs/reporting/statements/api">API Access to Reports
 ...
 * href="http://stripe.com/docs/keys#test-live-modes">live-mode API key</a>.
 *
 * @property string $id The <a href="http://stripe.com/docs/reporting/statements/api#available-report-types">ID of the Report Type</a>, such as <code>balance.summary.1</code>.
