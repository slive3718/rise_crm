 ...
 * @property null|string $currency Three-letter <a href="http://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="http://stripe.com/docs/currencies">supported currency</a>.
 ...
 * @property null|\Stripe\StripeObject $from_quote Details of the quote that was cloned. See the <a href="http://stripe.com/docs/quotes/clone">cloning documentation</a> for more details.
 ...
 * @property null|string $number A unique number that identifies this particular quote. This number is assigned once the quote is <a href="http://stripe.com/docs/quotes/overview#finalize">finalized</a>.
