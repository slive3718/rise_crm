 ...
 * href="http://stripe.com/docs/api/sources">Sources API</a>. We recommend that
 * you adopt the <a
 * href="http://stripe.com/docs/api/payment_methods">PaymentMethods API</a>. This
 * newer API provides access to our latest features and payment method types.
 *
 * Related guides: <a href="http://stripe.com/docs/sources">Sources API</a> and <a
 * href="http://stripe.com/docs/sources/customers">Sources &amp; Customers</a>.
 *
 ...
 * @property null|string $currency Three-letter <a href="http://stripe.com/docs/currencies">ISO code for the currency</a> associated with the source. This is the currency for which the source will be chargeable once ready. Required for <code>single_use</code> sources.
