 ...
 * href="http://stripe.com/docs/api#coupons">coupon</a>. It can be used to create
 ...
 * @property \Stripe\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="http://stripe.com/docs/api#subscriptions">subscriptions</a>, <a href="http://stripe.com/docs/api#invoices">invoices</a>, <a href="http://stripe.com/docs/api/checkout/sessions">checkout sessions</a>, <a href="http://stripe.com/docs/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="http://stripe.com/docs/api#create_charge">charges</a> or <a href="http://stripe.com/docs/api/payment_intents">payment intents</a>.
