 ...
 * href="http://stripe.com/docs/api#payment_intents">PaymentIntents</a> to drive
 * the payment flow.
 *
 ...
 * href="http://stripe.com/docs/payments/intents#intent-statuses">statuses</a> as
 ...
 * run through <a
 * href="http://stripe.com/docs/strong-customer-authentication">Strong Customer
 * Authentication</a> at the time of payment method collection in order to
 * streamline later <a
 * href="http://stripe.com/docs/payments/setup-intents">off-session payments</a>.
 * If the SetupIntent is used with a <a
 * href="http://stripe.com/docs/api#setup_intent_object-customer">Customer</a>,
 ...
 * href="http://stripe.com/docs/api#payment_intent_object-setup_future_usage">setup_future_usage</a>
 ...
 *
 * Related guide: <a href="http://stripe.com/docs/payments/setup-intents">Setup
 * Intents API</a>.
 *
 ...
 * @property string $status <a href="http://stripe.com/docs/payments/intents#intent-statuses">Status</a> of this SetupIntent, one of <code>requires_payment_method</code>, <code>requires_confirmation</code>, <code>requires_action</code>, <code>processing</code>, <code>canceled</code>, or <code>succeeded</code>.
