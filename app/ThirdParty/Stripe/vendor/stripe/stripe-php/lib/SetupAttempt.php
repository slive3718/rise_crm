 ...
 * @property null|string|\Stripe\StripeObject $application The value of <a href="http://stripe.com/docs/api/setup_intents/object#setup_intent_object-application">application</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\Stripe\Customer $customer The value of <a href="http://stripe.com/docs/api/setup_intents/object#setup_intent_object-customer">customer</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property null|string|\Stripe\Account $on_behalf_of The value of <a href="http://stripe.com/docs/api/setup_intents/object#setup_intent_object-on_behalf_of">on_behalf_of</a> on the SetupIntent at the time of this confirmation.
 ...
 * @property string $usage The value of <a href="http://stripe.com/docs/api/setup_intents/object#setup_intent_object-usage">usage</a> on the SetupIntent at the time of this confirmation, one of <code>off_session</code> or <code>on_session</code>.
 */
