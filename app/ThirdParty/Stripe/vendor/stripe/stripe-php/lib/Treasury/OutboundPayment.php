 ...
 * <a href="http://stripe.com/docs/api#financial_accounts">FinancialAccount</a>.
 * To send money to an account belonging to the same user, use an <a
 * href="http://stripe.com/docs/api#outbound_transfers">OutboundTransfer</a>.
 *
 ...
 * @property null|string $customer ID of the <a href="http://stripe.com/docs/api/customers">customer</a> to whom an OutboundPayment is sent.
 ...
 * @property null|string $hosted_regulatory_receipt_url A <a href="http://stripe.com/docs/treasury/moving-money/regulatory-receipts">hosted transaction receipt</a> URL that is provided when money movement is considered regulated under Stripe's money transmission licenses.
