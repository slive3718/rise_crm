 ...
 *
 * On the other hand <a
 * href="http://stripe.com/docs/api#external_accounts">External Accounts</a> are
 * transfer destinations on <code>Account</code> objects for <a
 * href="http://stripe.com/docs/connect/custom-accounts">Custom accounts</a>. They
 * can be bank accounts or debit cards as well, and are documented in the links
 * above.
 *
 * Related guide: <a
 * href="http://stripe.com/docs/payments/bank-debits-transfers">Bank Debits and
 * Transfers</a>.
 *
 ...
 * @property string $currency Three-letter <a href="http://stripe.com/docs/payouts">ISO code for the currency</a> paid out to the bank account.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @see http://stripe.com/docs/api/external_account_bank_accounts/object#account_bank_account_object-status
     */
