 ...
 * href="http://stripe.com/docs/api#retrieve_event">individual event</a> or a <a
 * href="http://stripe.com/docs/api#list_events">list of events</a> from the API.
 ...
 * managed in your <a href="http://dashboard.stripe.com/account/webhooks">account
 * settings</a>, and our <a href="http://stripe.com/docs/webhooks">Using
 * Webhooks</a> guide will help you get set up.
 *
 * When using <a href="http://stripe.com/docs/connect">Connect</a>, you can also
 ...
 * href="http://stripe.com/docs/api#retrieve_event">Retrieve Event API</a> is
 * guaranteed only for 30 days.
 *
 * This class includes constants for the possible string representations of
 * event types. See http://stripe.com/docs/api#event_types for more details.
 *
