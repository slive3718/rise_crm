 ...
 * href="http://stripe.com/docs/api#products">Products</a> help you track
 ...
 *
 * Related guides: <a
 * href="http://stripe.com/docs/billing/subscriptions/set-up-subscription">Set up
 * a subscription</a>, <a
 * href="http://stripe.com/docs/billing/invoices/create">create an invoice</a>,
 * and more about <a
 * href="http://stripe.com/docs/products-prices/overview">products and prices</a>.
 *
 ...
 * @property null|\Stripe\StripeObject $currency_options Prices defined in each available currency option. Each key must be a three-letter <a href="http://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="http://stripe.com/docs/currencies">supported currency</a>.
