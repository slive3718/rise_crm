 ...
 *
 * They contain <a href="http://stripe.com/docs/api#invoiceitems">invoice
 ...
 * the invoice, <a
 * href="http://stripe.com/docs/billing/invoices/workflow/#auto_advance">when
 ...
 * your <a href="http://dashboard.stripe.com/account/billing/automatic">email
 ...
 * href="http://stripe.com/docs/billing/customer/balance">here</a>.
 *
 * Related guide: <a href="http://stripe.com/docs/billing/invoices/sending">Send
 * Invoices to Customers</a>.
 *
 * @property null|string $id Unique identifier for the object. This property is always present unless the invoice is an upcoming invoice. See <a href="http://stripe.com/docs/api/invoices/upcoming">Retrieve an upcoming invoice</a> for more details.
 ...
 * @property null|bool $auto_advance Controls whether Stripe will perform <a href="http://stripe.com/docs/billing/invoices/workflow/#auto_advance">automatic collection</a> of the invoice. When <code>false</code>, the invoice's state will not automatically advance without an explicit action.
 ...
 * @property null|\Stripe\StripeObject $from_invoice Details of the invoice that was cloned. See the <a href="http://stripe.com/docs/invoicing/invoice-revisions">revision documentation</a> for more details.
 ...
 * @property null|\Stripe\StripeObject $metadata Set of <a href="http://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 ...
 * @property null|string $status The status of the invoice, one of <code>draft</code>, <code>open</code>, <code>paid</code>, <code>uncollectible</code>, or <code>void</code>. <a href="http://stripe.com/docs/billing/invoices/workflow#workflow-overview">Learn more</a>
