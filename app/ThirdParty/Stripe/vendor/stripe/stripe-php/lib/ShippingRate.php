 ...
 * can be applied to <a
 * href="http://stripe.com/docs/payments/checkout/shipping">Checkout Sessions</a>
 * and <a href="http://stripe.com/docs/orders/shipping">Orders</a> to collect
 * shipping costs.
 *
 ...
 * @property null|string|\Stripe\TaxCode $tax_code A <a href="http://stripe.com/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
