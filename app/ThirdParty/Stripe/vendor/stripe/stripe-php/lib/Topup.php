 ...
 * unique, random ID.
 *
 * Related guide: <a href="http://stripe.com/docs/connect/top-ups">Topping Up your
 * Platform Account</a>.
 *
 ...
 * @property null|string $failure_code Error code explaining reason for top-up failure if available (see <a href="http://stripe.com/docs/api#errors">the errors section</a> for a list of codes).
 ...
 * @property null|\Stripe\Source $source For most Stripe users, the source of every top-up is a bank account. This hash is then the <a href="http://stripe.com/docs/api#source_object">source object</a> describing that bank account.
