 ...
 * @property string[] $supported_payment_method_types The <a href="http://stripe.com/docs/api/payment_methods/object#payment_method_object-type">PaymentMethod type</a>(s) that can be created from this account.
 */
