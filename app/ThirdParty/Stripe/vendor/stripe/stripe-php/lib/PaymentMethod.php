 ...
 * them with <a
 * href="http://stripe.com/docs/payments/payment-intents">PaymentIntents</a> to
 * collect payments or save them to Customer objects to store instrument details
 * for future payments.
 *
 * Related guides: <a
 * href="http://stripe.com/docs/payments/payment-methods">Payment Methods</a> and
 * <a href="http://stripe.com/docs/payments/more-payment-scenarios">More Payment
 * Scenarios</a>.
 *
