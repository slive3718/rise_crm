...
/**
 * You can configure <a href="http://stripe.com/docs/webhooks/">webhook
 ...
 * href="http://dashboard.stripe.com/webhooks">the dashboard</a>, which provides a
 * user interface for registering and testing your webhook endpoints.
 *
 * Related guide: <a href="http://stripe.com/docs/webhooks/configure">Setting up
 * Webhooks</a>.
 *
 ...
 * @property null|string $secret The endpoint's secret, used to generate <a href="http://stripe.com/docs/webhooks/signatures">webhook signatures</a>. Only returned at creation.
