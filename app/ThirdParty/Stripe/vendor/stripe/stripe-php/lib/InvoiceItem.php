 ...
 * href="http://stripe.com/docs/api/invoices">invoice</a>. An invoice item is
 * added to an invoice by creating or updating it with an <code>invoice</code>
 * field, at which point it will be included as <a
 * href="http://stripe.com/docs/api/invoices/line_item">an invoice line item</a>
 * within <a
 * href="http://stripe.com/docs/api/invoices/object#invoice_object-lines">invoice.lines</a>.
 *
 ...
 * href="http://stripe.com/docs/api/subscriptions">subscription</a>. Sometimes you
 ...
 *
 * Related guides: <a
 * href="http://stripe.com/docs/invoicing/integration">Integrate with the
 * Invoicing API</a>, <a
 * href="http://stripe.com/docs/billing/invoices/subscription#adding-upcoming-invoice-items">Subscription
 * Invoices</a>.
 *
