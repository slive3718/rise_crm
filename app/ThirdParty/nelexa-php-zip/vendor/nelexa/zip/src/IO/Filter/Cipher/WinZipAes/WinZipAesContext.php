 ...
 *
 * @see http://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT APPENDIX E
 * @see http://www.winzip.com/win/en/aes_info.html
 *
 * @internal
 */
class WinZipAesContext
{
    ...
    public function __construct(int $encryptionStrengthBits, string $password, string $salt)
    {
        ...
        // WinZip 99-character limit http://sourceforge.net/p/p7zip/discussion/383044/thread/c859a2f0/
