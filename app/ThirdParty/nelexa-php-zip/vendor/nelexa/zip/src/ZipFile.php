 ...
 *
 * @see http://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT .ZIP File Format Specification
 */
class ZipFile implements \Countable, \ArrayAccess, \Iterator
{
     ...
     *
     * @return ZipFile
     * @sse http://en.wikipedia.org/wiki/Glob_(programming) Glob pattern syntax
     */
