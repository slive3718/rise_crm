...
class X509
{
    ...
    public function __construct()
    {
        ...
        if (!self::$oidsLoaded) {
            ...
            ASN1::loadOIDs([
                ...
                // from http://tools.ietf.org/html/rfc5758#section-3.2
                ...
                // from http://tools.ietf.org/html/rfc5758#section-3.1
                'id-dsa-with-sha224' => '2.16.840.1.101.3.4.3.1',
                'id-dsa-with-sha256' => '2.16.840.1.101.3.4.3.2',

                // from http://tools.ietf.org/html/rfc8410:
    ...
    private function getMapping($extnId)
    {
        ...
        switch ($extnId) {
            ...
            // http://tools.ietf.org/html/rfc3739#section-3.2.6
     ...
     *
     * See http://tools.ietf.org/html/rfc4325 for more info
     *
     * @param bool $caonly
     * @param int $count
     * @return bool
    ...
    private function testForIntermediate($caonly, $count)
    {
        ...
        foreach ($opts as $opt) {
            if ($opt['accessMethod'] == 'id-ad-caIssuers') {
                ...
                // etc, but we're only supporting URI's. URI's and LDAP are the only thing http://tools.ietf.org/html/rfc4325
                // discusses
        ...
        /*
         "Conforming applications that support HTTP or FTP for accessing
          ...
          to accept .p7c files." -- http://tools.ietf.org/html/rfc4325
    ...
    public function removeDNProp($propName)
    {
        ...
        $dn = array_values($dn);
        // fix for http://bugs.php.net/75433 affecting PHP 7.2
        if (!isset($dn[0])) {
     ...
     *
     * http://developer.mozilla.org/en-US/docs/HTML/Element/keygen
     *
     * @param string $spkac
     * @return mixed
     */
        ...
        if (isset($this->currentCert) && is_array($this->currentCert) && isset($this->currentCert['publicKeyAndChallenge'])) {
            ...
            $this->currentCert = [
                'publicKeyAndChallenge' =>
                    [
                        'spki' => $publicKey,
                        // quoting <http://developer.mozilla.org/en-US/docs/Web/HTML/Element/keygen>,
