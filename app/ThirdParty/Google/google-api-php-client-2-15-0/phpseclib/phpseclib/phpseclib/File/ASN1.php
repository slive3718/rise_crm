...
abstract class ASN1
{
    ...
    public static function decodeOID($content)
    {
        ...
        /*
          ...
          -- http://www.itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf#page=22
        */
    ...
    private static function decodeTime($content, $tag)
    {
        ...
        if ($tag == self::TYPE_UTC_TIME) {
            // http://www.itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf#page=28 says "the seconds
