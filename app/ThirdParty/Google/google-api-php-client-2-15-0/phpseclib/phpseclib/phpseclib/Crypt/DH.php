    ...
    public static function createParameters(...$args)
    {
        ...
        switch ($args[0]) {
            ...
            case 'diffie-hellman-group14-sha256':
                ...
                break;
            // see http://tools.ietf.org/html/rfc3526#section-4
            case 'diffie-hellman-group15-sha512': // 3072-bit MODP Group
                ...
                break;
            // see http://tools.ietf.org/html/rfc3526#section-5
            case 'diffie-hellman-group16-sha512': // 4096-bit MODP Group
                ...
                break;
            // see http://tools.ietf.org/html/rfc3526#section-6
            case 'diffie-hellman-group17-sha512': // 6144-bit MODP Group
                ...
                break;
            // see http://tools.ietf.org/html/rfc3526#section-7
                ...
                case is_string($public):
                    ...
                    switch ($private->getCurve()) {
                        ...
                        case 'Curve448':
                            ...
                            break;
                        default:
                            // according to http://www.secg.org/sec1-v2.pdf#page=33 only X is returned
