...
class Ed25519 extends TwistedEdwards
{
    const HASH = 'sha512';
    /*
      Per http://tools.ietf.org/html/rfc8032#page-6 EdDSA has several parameters, one of which is b:
    ...
    */
     ...
     * Recover X from Y
     *
     * Implements steps 2-4 at http://tools.ietf.org/html/rfc8032#section-5.1.3
     *
    ...
    public function recoverX(BigInteger $y, $sign)
    {
        ...
        /* we don't do $x2->squareRoot() because, quoting from
           http://tools.ietf.org/html/rfc8032#section-5.1.1:
     ...
     *
     * Implements steps 1-3 at http://tools.ietf.org/html/rfc8032#section-5.1.5
     *
     ...
     *
     * From http://tools.ietf.org/html/rfc8032#section-5.1.4 :
     *
    ...
    public function doublePoint(array $p)
    {
        ...
        // from http://tools.ietf.org/html/rfc8032#page-12
