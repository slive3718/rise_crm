...
trait Common
{
    ...
    public static function extractPoint($str, BaseCurve $curve)
    {
        if ($curve instanceof TwistedEdwardsCurve) {
            ...
            // http://tools.ietf.org/html/rfc8032#section-5.1.3
            // http://tools.ietf.org/html/rfc8032#section-5.2.3
            $y = $str;
            $y = strrev($y);
    ...
    private static function encodeParameters(BaseCurve $curve, $returnArray = false, array $options = [])
    {
        ...
        // http://crypto.stackexchange.com/a/27914/4520
        ...
        if ($curve instanceof PrimeCurve) {
            ...
            // http://crypto.stackexchange.com/q/28947/4520
            $data = [
                'version' => 'ecdpVer1',
                'fieldID' => [
