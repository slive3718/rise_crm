 ...
 *
 * http://github.com/openssh/openssh-portable/blob/master/openbsd-compat/bcrypt_pbkdf.c
 *
...
class Blowfish extends BlockCipher
{
    ...
    protected function isValidEngineHelper($engine)
    {
        if ($engine == self::ENGINE_OPENSSL) {
            ...
            // quoting http://www.openssl.org/news/openssl-3.0-notes.html, OpenSSL 3.0.1
