...
abstract class MSBLOB
{
    ...
    public static function load($key, $password = '')
    {
        ...
        // http://msdn.microsoft.com/en-us/library/windows/desktop/aa387453(v=vs.85).aspx
        ...
        // RSAPUBKEY rsapubkey
        // http://msdn.microsoft.com/en-us/library/windows/desktop/aa387685(v=vs.85).aspx
