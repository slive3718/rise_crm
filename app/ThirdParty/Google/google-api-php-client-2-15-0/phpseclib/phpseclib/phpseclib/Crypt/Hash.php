...
class Hash
{
     ...
     *
     * As documented in http://www.reddit.com/r/PHP/comments/9nct2l/symfonypolyfill_hash_pbkdf2_correct_fix_for/
    ...
    private function pdf()
    {
        ...
        // we could use ord() but per http://paragonie.com/blog/2016/06/constant-time-encoding-boring-cryptography-rfc-4648-and-you
    ...
    public function hash($text)
    {
        ...
        if (is_array($algo)) {
            ...
            // SHA3 HMACs are discussed at http://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.202.pdf#page=30
    ...
    private static function sha3_pad($padLength, $padType)
    {
        switch ($padType) {
            ...
            default:
                // from http://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.202.pdf#page=36
     ...
     * for SHA3.
     *
     * In http://ws680.nist.gov/publication/get_pdf.cfm?pub_id=919061#page=16 KECCAK[C] is
