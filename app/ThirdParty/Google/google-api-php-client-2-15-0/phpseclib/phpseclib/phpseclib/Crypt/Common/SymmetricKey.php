...
abstract class SymmetricKey
{
                ...
                case (php_uname('m') & "\xDF\xDF\xDF") == 'ARM':
                    switch (true) {
                        /* PHP 7.0.0 introduced a bug that affected 32-bit ARM processors:
                           ...
                           http://github.com/php/php-src/commit/716da71446ebbd40fa6cf2cea8a4b70f504cc3cd

                           altho the changelogs make no mention of it, this bug was fixed with this commit:

                           http://github.com/php/php-src/commit/c1729272b17a1fe893d1a54e423d3b71470f3ee8
     ...
     *     {@link http://en.wikipedia.org/wiki/Bcrypt bcypt}:
     *         $salt, $rounds, $keylen
     *
    ...
    public function setPassword($password, $method = 'pbkdf2', ...$func_args)
    {
        ...
        switch ($method) {
            case 'bcrypt':
                ...
                return true;
            case 'pkcs12': // from http://tools.ietf.org/html/rfc7292#appendix-B.2
            case 'pbkdf1':
            case 'pbkdf2':
                // Hash function
                ...
                switch (true) {
                    case $method == 'pkcs12':
                        /*
                         ...
                         -- http://tools.ietf.org/html/rfc7292#appendix-B.1
                         */
     ...
     * As discussed here:
     *
     * {@link http://tools.ietf.org/html/rfc7292#appendix-B}
     *
     * @see self::setPassword()
     * @param int $n
    ...
    public function getTag($length = 16)
    {
        ...
        // easily brute forced.
        // see http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf#page=36
        // for more info
    ...
    protected function createInlineCryptFunction($cipher_code)
    {
        ...
        // @see http://github.com/phpseclib/phpseclib/issues/1293
        // @see http://github.com/phpseclib/phpseclib/pull/1143
     ...
     *
     * See steps 1-2 of http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf#page=23
     * for more info
     *
     */
     ...
     *
     * See http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf#page=20
     * for more info
     *
     * @see self::decrypt()
     * @see self::encrypt()
    ...
    private function ghash($x)
    {
        ...
        // endian order per http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38d.pdf#page=19.
