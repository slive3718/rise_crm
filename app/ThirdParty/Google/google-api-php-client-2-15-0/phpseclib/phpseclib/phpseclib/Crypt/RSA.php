...
abstract class RSA extends AsymmetricKey
{
    ...
    protected function emsa_pkcs1_v1_5_encode($m, $emLen)
    {
        ...
        switch ($this->hash->getHash()) {
            ...
            case 'sha512':
                ...
                break;
            // from http://www.emc.com/collateral/white-papers/h11300-pkcs-1v2-2-rsa-cryptography-standard-wp.pdf#page=40
            case 'sha224':
     ...
     *
     * Quoting http://tools.ietf.org/html/rfc8017#page-65,
     *
