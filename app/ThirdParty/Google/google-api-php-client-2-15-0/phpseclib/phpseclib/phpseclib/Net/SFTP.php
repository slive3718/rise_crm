...
class SFTP extends SSH2
{
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (empty(self::$packet_types)) {
            ...
            // http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-8.1.1.3
            self::$open_flags5 = [
    ...
    public function realpath($path)
    {
        ...
        if (!$this->canonicalize_paths) {
            ...
            foreach ($parts as $part) {
                switch ($part) {
                    //case '': // some SFTP servers /require/ double /'s. see http://github.com/phpseclib/phpseclib/pull/1137
                    case '.':
                        break;
                    case '..':
                        if (!empty($afterPWD)) {
    ...
    {
        /*
         quoting <http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.5>,
    ...
    public function symlink($target, $link)
    {
        ...
        /* quoting http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-09#section-12.1 :
    ...
    public function rename($oldname, $newname)
    {
        ...
        if ($this->version >= 5) {
            /* quoting http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-05#section-6.5 ,
        ...
        foreach (self::$attributes as $key => $value) {
            ...
            switch ($flags & $key) {
                ...
                case NET_SFTP_ATTR_ACL:              // 0x00000040
                    // access control list
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-04#section-5.7
                ...
                case NET_SFTP_ATTR_BITS:             // 0x00000200 (SFTPv5+)
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-05#section-5.8
                    // currently unsupported
                ...
                case NET_SFTP_ATTR_ALLOCATION_SIZE:  // 0x00000400 (SFTPv6+)
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.4
                ...
                case NET_SFTP_ATTR_TEXT_HINT:        // 0x00000800
                    // http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.10
                    // currently unsupported
                ...
                case NET_SFTP_ATTR_MIME_TYPE:        // 0x00001000
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.11
                    list($attr['mime-type']) = Strings::unpackSSH2('s', $response);
                    break;
                case NET_SFTP_ATTR_LINK_COUNT:       // 0x00002000
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.12
                    list($attr['link-count']) = Strings::unpackSSH2('N', $response);
                    break;
                case NET_SFTP_ATTR_UNTRANSLATED_NAME:// 0x00004000
                    // see http://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.13
