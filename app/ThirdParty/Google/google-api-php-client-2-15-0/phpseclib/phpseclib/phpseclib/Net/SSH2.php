...
class SSH2
{
     ...
     *
     * @see http://tools.ietf.org/html/rfc4252#section-5.1
     * @var array|null
     */
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        /**
         * Typehint is required due to a bug in Psalm: http://github.com/vimeo/psalm/issues/7508
     ...
     *
     * http://tools.ietf.org/html/rfc4253#section-4.2 says "when the connection has been established,
     ...
     *
     * http://tools.ietf.org/html/rfc4253#section-7.1 says "key exchange begins by each sending
     ...
     *
     * Quoting http://stackoverflow.com/a/14262151/569976,
    ...
    private function connect()
    {
        ...
        // http://bugs.launchpad.net/ubuntu/+source/openssh/+bug/1334916 for more info.
        // http://lists.ubuntu.com/archives/oneiric-changes/2011-July/005772.html discusses
        // when consolekit was incorporated.
        // http://marc.info/?l=openssh-unix-dev&m=163409903417589&w=2 discusses some of the
    ...
    private function key_exchange($kexinit_payload_server = false)
    {
        ...
        if ($this->decrypt) {
            ...
            switch ($decrypt) {
                case 'aes128-gcm@openssh.com':
                case 'aes256-gcm@openssh.com':
                    // see http://tools.ietf.org/html/rfc5647#section-7.1
     ...
     *
     * @link http://www.chiark.greenend.org.uk/~sgtatham/putty/wishlist/ssh2-aesctr-openssh.html
     * @link http://bugzilla.mindrot.org/show_bug.cgi?id=1291
     * @param string $algorithm Name of the encryption algorithm
     * @return bool
     */
    ...
    {
        return [
            'ssh-ed25519', // http://tools.ietf.org/html/draft-ietf-curdle-ssh-ed25519-02
    ...
    {
        $algos = [
            // from <http://tools.ietf.org/html/rfc5647>:
            ...
            // from <http://github.com/openssh/openssh-portable/blob/001aa55/PROTOCOL.chacha20poly1305>:
    ...
    public static function getSupportedMACAlgorithms()
    {
        return [
            ...
            // from <http://tools.ietf.org/html/draft-miller-secsh-umac-01>:
            'umac-64@openssh.com',
    ...
    public static function getSupportedCompressionAlgorithms()
    {
        ...
        if (function_exists('deflate_init')) {
            $algos[] = 'zlib@openssh.com'; // http://datatracker.ietf.org/doc/html/draft-miller-secsh-compression-delayed
            $algos[] = 'zlib';
        }
        return $algos;
    }
     ...
     *
     * Uses the same format as http://www.php.net/ssh2-methods-negotiated
     *
     * @return array
     */
