...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     *
     * @see http://bugs.php.net/bug.php?id=52923
     * @see http://www.php.net/manual/en/function.parse-url.php#114817
     * @see http://curl.haxx.se/libcurl/c/CURLOPT_URL.html#ENCODING
     *
     * @return array|false
     */
