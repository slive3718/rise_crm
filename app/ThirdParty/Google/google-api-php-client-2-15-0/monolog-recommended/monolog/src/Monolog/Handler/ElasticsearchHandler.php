 ...
 *
 * @link http://www.elastic.co/guide/en/elasticsearch/client/php-api/current/index.html
 *
    ...
    public function __construct(Client|Client8 $client, array $options = [], int|string|Level $level = Level::Debug, bool $bubble = true)
    {
        ...
        $this->options = array_merge(
            [
                ...
                'op_type'      => 'index',   // Elastic op_type (index or create) (http://www.elastic.co/guide/en/elasticsearch/reference/current/docs-index_.html#docs-index-api-op_type)
            ],
            $options
        );
