...
/**
 * SendGridrHandler uses the SendGrid API v2 function to send Log emails, more information in http://sendgrid.com/docs/API_Reference/Web_API/mail.html
 *
...
class SendGridHandler extends MailHandler
{
    ...
    protected function send(string $content, array $records): void
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'http://api.sendgrid.com/api/mail.send.json');
