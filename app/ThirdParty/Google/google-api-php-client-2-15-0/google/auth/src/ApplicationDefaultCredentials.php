 ...
 *     'http://www.googleapis.com/auth/taskqueue'
 * );
 ...
 * $client = new Client([
 *     'handler' => $stack,
 *     'base_uri' => 'http://www.googleapis.com/taskqueue/v1beta2/projects/',
...
class ApplicationDefaultCredentials
{
    ...
    private static function notFound()
    {
        ...
        $msg .= 'http://cloud.google.com/docs/authentication/external/set-up-adc';
