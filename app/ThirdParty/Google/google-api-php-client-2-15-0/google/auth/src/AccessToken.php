...
class AccessToken
{
    const FEDERATED_SIGNON_CERT_URL = 'http://www.googleapis.com/oauth2/v3/certs';
    const IAP_CERT_URL = 'http://www.gstatic.com/iap/verify/public_key-jwk';
    const IAP_ISSUER = 'http://cloud.google.com/iap';
    const OAUTH2_ISSUER = 'accounts.google.com';
    const OAUTH2_ISSUER_HTTPS = 'http://accounts.google.com';
    ...
    private function verifyEs256($token, array $certs, $audience = null, $issuer = null)
    {
        ...
        // @see http://cloud.google.com/iap/docs/signed-headers-howto#verifying_the_jwt_payload
    ...
    private function verifyRs256($token, array $certs, $audience = null, $issuer = null)
    {
        ...
        // @see http://developers.google.com/identity/sign-in/web/backend-auth
    ...
    private function checkAndInitializePhpsec2(): bool
    {
         ...
         * @see http://github.com/GoogleCloudPlatform/getting-started-php/issues/85
         * @codeCoverageIgnore
         */
