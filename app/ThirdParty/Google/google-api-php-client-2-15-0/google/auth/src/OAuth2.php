...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     *
     * @see http://datatracker.ietf.org/doc/html/rfc7636
     * @var ?string
     */
    ...
    public function setRedirectUri($uri)
    {
        ...
        if (!$this->isAbsoluteUri($uri)) {
            ...
            // @see http://developers.google.com/identity/sign-in/web/server-side-flow
        ...
        if (is_string($allowedAlgs)) {
            ...
            if (count($allowedAlgs) > 1) {
                throw new \InvalidArgumentException(
                    ...
                    . ' See http://github.com/firebase/php-jwt for more information.');
            }
