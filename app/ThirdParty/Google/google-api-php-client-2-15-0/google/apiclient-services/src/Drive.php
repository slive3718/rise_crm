 ...
 * <a href="http://developers.google.com/drive/" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class Drive extends \Google\Service
{
  ...
  const DRIVE_APPDATA =
      "http://www.googleapis.com/auth/drive.appdata";
  ...
  const DRIVE_PHOTOS_READONLY =
      "http://www.googleapis.com/auth/drive.photos.readonly";
  /** See and download all your Google Drive files. */
  const DRIVE_READONLY =
      "http://www.googleapis.com/auth/drive.readonly";
  /** Modify your Google Apps Script scripts' behavior. */
  const DRIVE_SCRIPTS =
      "http://www.googleapis.com/auth/drive.scripts";
