 ...
 * <a href="http://developers.google.com/google-apps/calendar/firstapp" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class Calendar extends \Google\Service
{
  ...
  const CALENDAR_EVENTS =
      "http://www.googleapis.com/auth/calendar.events";
  /** View events on all your calendars. */
  const CALENDAR_EVENTS_READONLY =
      "http://www.googleapis.com/auth/calendar.events.readonly";
  /** See and download any calendar you can access using your Google Calendar. */
  const CALENDAR_READONLY =
      "http://www.googleapis.com/auth/calendar.readonly";
  /** View your Calendar settings. */
  const CALENDAR_SETTINGS_READONLY =
      "http://www.googleapis.com/auth/calendar.settings.readonly";
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->rootUrl = $rootUrl ?: 'http://www.googleapis.com/';
