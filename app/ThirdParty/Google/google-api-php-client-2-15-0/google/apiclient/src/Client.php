...
class Client
{
    ...
    const OAUTH2_REVOKE_URI = 'http://oauth2.googleapis.com/revoke';
    const OAUTH2_TOKEN_URI = 'http://oauth2.googleapis.com/token';
    const OAUTH2_AUTH_URL = 'http://accounts.google.com/o/oauth2/v2/auth';
    const API_BASE_PATH = 'http://www.googleapis.com';
    ...
    public function __construct(array $config = [])
    {
        $this->config = array_merge([
            ...
            // @see http://developers.google.com/identity/protocols/application-default-credentials
     ...
     * @link http://developers.google.com/+/api/moment-types
     *
     ...
     *        'http://www.googleapis.com/auth/moderator'
     *    );
     */
    ...
    private function createApplicationDefaultCredentials()
    {
        ...
        // @see http://developers.google.com/identity/protocols/OAuth2ServiceAccount
        if ($sub) {
    ...
    protected function getAuthHandler()
    {
        ...
        // sessions.
        //
        // @see http://github.com/google/google-api-php-client/issues/821
