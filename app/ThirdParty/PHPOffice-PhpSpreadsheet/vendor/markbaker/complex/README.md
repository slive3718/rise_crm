...
[![Build Status](http://github.com/MarkBaker/PHPComplex/workflows/main/badge.svg)](http://github.com/MarkBaker/PHPComplex/actions)
[![Total Downloads](http://img.shields.io/packagist/dt/markbaker/complex)](http://packagist.org/packages/markbaker/complex)
[![Latest Stable Version](http://img.shields.io/github/v/release/MarkBaker/PHPComplex)](http://packagist.org/packages/markbaker/complex)
[![License](http://img.shields.io/github/license/MarkBaker/PHPComplex)](http://packagist.org/packages/markbaker/complex)


[![Complex Numbers](http://imgs.xkcd.com/comics/complex_numbers_2x.png)](http://xkcd.com/2028/)
...
If you've previously been using procedural calls to functions and operations using this library, then from version 3.0 you should use [MarkBaker/PHPComplexFunctions](http://github.com/MarkBaker/PHPComplexFunctions) instead (available on packagist as [markbaker/complex-functions](http://packagist.org/packages/markbaker/complex-functions)).
