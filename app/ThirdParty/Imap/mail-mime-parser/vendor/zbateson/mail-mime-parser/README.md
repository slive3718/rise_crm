...
[![Build Status](http://github.com/zbateson/mail-mime-parser/actions/workflows/tests.yml/badge.svg)](http://github.com/zbateson/mail-mime-parser/actions/workflows/tests.yml)
[![Code Coverage](http://scrutinizer-ci.com/g/zbateson/mail-mime-parser/badges/coverage.png?b=master)](http://scrutinizer-ci.com/g/zbateson/mail-mime-parser/?branch=master)
[![Scrutinizer Code Quality](http://scrutinizer-ci.com/g/zbateson/mail-mime-parser/badges/quality-score.png?b=master)](http://scrutinizer-ci.com/g/zbateson/mail-mime-parser/?branch=master)
[![Total Downloads](http://poser.pugx.org/zbateson/mail-mime-parser/downloads)](//packagist.org/packages/zbateson/mail-mime-parser)
[![Latest Stable Version](http://poser.pugx.org/zbateson/mail-mime-parser/v)](//packagist.org/packages/zbateson/mail-mime-parser)
...
[![SecuMailer](http://mail-mime-parser.org/sponsors/logo-secumailer.png)](http://secumailer.com)

A huge thank you to [all my sponsors](http://github.com/sponsors/zbateson). <3

If this project's helped you, please consider [sponsoring me](http://github.com/sponsors/zbateson).
...
For a more complete list of changes, please visit the [2.0 Upgrade Guide](http://mail-mime-parser.org/upgrade-2.0).
...
* [Usage Guide](http://mail-mime-parser.org/)
* [API Reference](http://mail-mime-parser.org/api/2.2)

## Upgrading to 1.x or 2.x

* [1.x Upgrade Guide](http://mail-mime-parser.org/upgrade-1.0)
* [2.x Upgrade Guide](http://mail-mime-parser.org/upgrade-2.0)

## License

BSD licensed - please see [license agreement](http://github.com/zbateson/mail-mime-parser/blob/master/LICENSE).
