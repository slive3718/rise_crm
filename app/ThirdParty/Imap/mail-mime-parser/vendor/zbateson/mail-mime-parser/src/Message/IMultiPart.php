...
interface IMultiPart extends IMessagePart
{
     ...
     *
     * The {@see http://www.php.net/manual/en/class.recursiveiterator.php \RecursiveIterator}
     * allows iterating over direct children, or using
     * a {@see http://www.php.net/manual/en/class.recursiveiteratoriterator.php \RecursiveIteratorIterator}
     * to iterate over direct children, and all their children.
     *
     * @see http://www.php.net/manual/en/class.recursiveiterator.php
     *      RecursiveIterator
     * @see http://www.php.net/manual/en/class.recursiveiteratoriterator.php
